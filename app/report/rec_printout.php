...
<div class="col-sm-12">
  ...
  <table id="examplebpo" class="display" style="width:100%">
    <thead>
  ...
  $sql = "SELECT * FROM RECEIPTS WHERE Term = '$term' AND Session = '$session' GROUP BY CLASS" ;
...
<script>
  ...
  $('.modalButton').click(function(){
        ...
        $.ajax({url:"receipt_print.php?Bid="+Bid,cache:false,success:function(result){
