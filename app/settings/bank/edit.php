...
if(isset($_GET['submit'])){
  $index = $_GET['submit'];
    ...
    $sql = "SELECT * FROM BANK WHERE ID = $index";
              ...
              <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                           <input class="form-control form-control-lg" type="text" id="number" name="number" value="<?php echo $account; ?>">
                          </div>
                        </div>
                      </div>  
                      <div class="col-md-6">
...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
      ...
      if(isset($_POST['edit'])){
        ...
        $stmt = $db->prepare("UPDATE BANK SET  `NAME` =  '".$name."', `Acc_No` =  '".$account."', `Balance` =  '".$balance."' WHERE ID = $id ");
           $stmt->execute();
