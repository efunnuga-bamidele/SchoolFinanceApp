    ...
    <div class="row">
      <div class="col-md-10 mx-auto">
        <div class="card card-body mt-5">
            <h2>Edit Payroll Items</h2>
            <p>Fill in the form name of item to pay</p>
                     ...
                     <input type="submit" name ="Delete" value="Delete"  class="btn btn-secondary btn-block" disabled>
                      ...
                      <div class="col-md-3">
                        <div class="form-group row">
                         <form method="POST">
                      <div class="col">
                     <input type="submit" name ="Clear" value="Cancel" formaction="payroll_form.php" class="btn btn-warning btn-block" >
                      </div>
                      </form>
                        </div>
                      </div>
