  ...
  <div class="container-fluid" style="padding-left: 45px;">
    <div class="row">
      <div class="col-md-12 mx-auto">
        ...
        <h3>Payroll Item Table</h3>
        <ul class="breadcrumb">
            <li><a href="../../index.php">Home</a></li>
            <li><a href="">Payroll Section</a></li>
...
foreach ($data as $row) {
    echo "
          <tr>
            ...
            <td>
              <a class='btn btn-warning' href='payroll_edit.php?index=" . $index . "'>Edit</a>
...
$(document).ready(function(){
    $("#example td").change(function() {
        ...
        $.getJSON("payrolltable.json", function(json) {
