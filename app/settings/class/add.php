    ...
    <div class="row">
      <div class="col-md-10 mx-auto">
        <div class="card card-body mt-5">
            <h2>Create Class Items</h2>
            <p>Fill in The Class Name</p>
            <form action="" method="POST">
              <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Class Level</label>
                          <div class="col-sm-9">
                           <input class="form-control form-control-lg" type="text" id="level" name="level" >
                          </div>
                        </div>
                      </div>                   
                    </div>
