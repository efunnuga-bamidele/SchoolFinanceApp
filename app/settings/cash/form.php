  ...
  <div class="container-fluid" style="padding-left: 45px;">
    <div class="row">
      <div class="col-md-12 mx-auto">
        ...
        <h3>Cash Detail Table</h3>
        <ul class="breadcrumb">
            <li><a href="../../index.php">Home</a></li>
            <li><a href="">Cash Section</a></li>
            <li><a href="">Cash Data</a></li>
            <li>Cash Data Table</li>
        </ul>
          ...
          <td>
            ...
            <div class="col-sm-4">
              <form action="delete.php" method="GET">
                <button class="btn btn-danger" name="submit" value="<?php echo $row['ID'];?>" hidden><i class="fa fa-trash"></i></button>
              </form>
            </div>
            </div>
          </td>
