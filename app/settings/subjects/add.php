...
<body class="register_area">
  ...
  <div class="container-fluid" >
    <div class="row">
      <div class="col-md-10 mx-auto">
        <div class="card card-body mt-5">
            <h2>Create Billing Items</h2>
            <p>Fill in the form name of item to bill</p>
              ...
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                        <div class="form-group row">
                          <div class="col">
                        <input class="form-control form-control-lg" type="submit" name ="Save" value="Save"  class="btn btn-primary btn-block" >
                      </div>
                        </div>
                      </div>
                       <div class="col-md-3">
                     ...
                     <input type="submit" name ="Delete" value="Delete"  class="btn btn-secondary btn-block" disabled>
                      ...
                      <form method="POST">
                      <div class="col">
                     <input type="submit" name ="Clear" value="Cancel" formaction="fee_form.php" class="btn btn-warning btn-block" >
                      </div>
                      </form>
                        </div>
                      </div>
	...
	if(isset($_POST['Save'])){
		...
		file_put_contents('feetable.json', $data);

	
echo("<script>location.href = 'fee_form.php';</script>");
	}
?>
        </div>
      </div>
